  ...
  <div class="heightP100">
    <el-row :gutter="10">
      ...
      <div :gutter="10" class="marginL10 floatL">
        ...
        <el-date-picker value-format="yyyy-MM-dd" clearable class="width130" v-model="openDate" :editable="false"
                        type="date" align="right" placeholder="开始日期" @change="dateChanged('openDate', $event)"
                        size="small">
        </el-date-picker>
      </div>
