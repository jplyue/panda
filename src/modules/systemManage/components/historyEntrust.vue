<template>
    ...
    <el-table v-loading="bTableLoading" :data="aTableData" border stripe ref="filterTable" @filter-change="filterTag" @row-click="selectedRow" class="label6-hover">
        <el-table-column fixed label="账户标识" min-width="120px" align="center" :resizable="false" show-overflow-tooltip>
        ...
        <el-table-column label="委托类型" align="center" prop="select"
            min-width="100px" 
            :resizable="false"
    ...
    data() {
     ...
     methods:{
        ...
        getTableData(){
            ...
            API.historyEntrust(data).then(res => {
