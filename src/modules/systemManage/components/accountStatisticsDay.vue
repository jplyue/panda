  ...
  export default {
    ...
    methods: {
      ...
      getTableData() {
        ...
        API.accountStatisticsDay(data).then(res => {
      ...
      exportExcelData() {
        axios.get("/api/heart/saas/march/statistics/account/countDayExcel?accountId=" + this.accountId + "&tradeDate=" + this.tradeDate + "",{responseType: 'blob'}).then(response => {
